...
##### Container Configuration Variables: #####
	...
	# Container Variables That Must Be Unique For A Given Code Implementation To Allow Concurrent Runs
		...
		COMPOSE_PROJECT_NAME=code_parr_tools
	...
	APP_SCHEMA_NAME=PICDM

##### Project Configuration Variables: #####

	# define the container git project URL
	GIT_URL="--branch Branch_CODE_v1.4_install git@github.com:noaa-pifsc/PIFSC-PARR-Tools-Containerized-Oracle-Development-Environment.git"